...
#disable javascript for nyt to bypass paywall
config.set('content.javascript.enabled',False, '*://www.nytimes.com/*')  

# Setting dark mode
#config.set("colors.webpage.darkmode.enabled", True)

#c.aliases['reader'] = 'http://webcache.googleusercontent.com/search?q=cache:nytimes.com'
...
c.colors.tabs.selected.even.bg = "#5A5A5A"
c.colors.tabs.selected.odd.bg = "#5A5A5A"
...
#set aliases
c.aliases['ny'] = 'open -t https://nytimes.com/'
c.aliases['ms'] = 'open -t https://math.stackexchange.com/'
c.aliases['yt'] = 'open -t https//www.youtube.com/'
c.aliases['fb'] = 'open -t https://www.facebook.com/'
c.aliases['wa'] = 'open -t https://https://web.whatsapp.com/'

#set newsfeed (script is in ~/.local/share/qutebrowser/userscripts/)
c.aliases['yn'] = 'spawn --userscript  qutebrowser-youtube-chl-to-newsboat.sh {url} {title}'
...
#config.bind('N', 'set-cmd-text -s :open -t http://webcache.googleusercontent.com/search?q=cache:nytimes.com')
