...
myEmail :: String               -- Sets e-mail client
myEmail = "thunderbird"
...
--  spawn "killall conky"   -- kill current conky on each restart
  ...
  spawnOnce "xsetroot -xcf /usr/share/icons/KanadaCursors/cursors/left_ptr 48" --set cursor size
  spawnOnce "lxsession"
--  spawnOnce "picom"
...
myManageHook = composeAll
 ...
 -- , className =? "vlc"         --> doCenterFloat
  ...
  , className =? "tmux"             --> doShift ( myWorkspaces !! 0)
...
--  , ("<XF86MonBrightnessDown>", addName "Lower Bright"                       $ spawn "brightnessctl set 10%-")
  ...
  , ("<Print>", addName "flameshot" $ spawn "flameshot")
  ]
...
-- My Keybindings
  ...
  [  ("M-M1-1", addName "Google"     $spawn (myBrowser))
    ...
    , ("M-M1-9", addName "tmux"      $spawn ("kitty -e tmux")) 
    , ("M-M1-0", addName "opera"     $spawn (myBrowser1)) 
