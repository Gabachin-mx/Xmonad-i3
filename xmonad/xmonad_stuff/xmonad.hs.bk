...
myWorkspaces = [" chrome ", " alacritty ", " thunar ", " search ", " torrent ", " blueman ", " vlc ", " ranger ", " 9 "]
...
-- My Keybindings
  ...
  [  ("M-M1-1", addName "Google"     $spawn (myBrowser))
    ...
    , ("M-M1-8", addName "ranger"    $spawn ("alacritty -e ranger")) 
...
--        , ppTitle = xmobarColor color16 "" . shorten 60
   ...
   where
       ...
       foobar = xmobarColor color06 color06
