...
export FZF_DEFAULT_COMMAND="find . -maxdepth 4 | sed 's/^..//'" #cuts the annoying ./ at beginning of line
...
alias lt='exa -alT --level 3 --color=always --group-directories-first' # tree listing
alias l.='exa -a | egrep "^\."'
...
#search youtube videos with ytfzf
alias ynt='ytfzf' # no thumbnails
alias ytt='ytfzf -t' # thumbnails
